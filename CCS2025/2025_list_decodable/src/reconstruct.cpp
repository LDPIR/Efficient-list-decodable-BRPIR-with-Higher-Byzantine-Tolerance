...
// This is the reconstruction algorithm for scheme Gamma_1

void Reconstruct1(int _index, fmpz_t * A_vals, fmpz_t ** A_partials, fmpz_t * aux1, fmpz_t ** aux2, fmpz_t * & res){
    fmpz_t temp;
    ...
    Li_decoding1(k, k - b, w, D, aux1, alpha, beta, polys, count);
...
void Li_decoding1(int total_num, int corr_num, int degree, int D, fmpz_t * lambda, fmpz_t * alpha, fmpz_t * beta, fmpz_mod_poly_t * & polys, int & count){    
